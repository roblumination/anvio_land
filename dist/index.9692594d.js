...
function render() {
    ...
    //menu
    modals.menu.style.transform = state.modalSmallMenuIsActive ? "translateX(0px)" : "translateX(300px)";
    modals.menu.style.opacity = state.modalSmallMenuIsActive ? "1" : "0.0";
    modals.menu.style.pointerEvents = state.modalSmallMenuIsActive ? "all" : "none";
    buttons.menu.style.backgroundColor = state.modalSmallMenuIsActive ? "#fff" : "#fff0";
    menuIco.closed.style.display = state.modalSmallMenuIsActive ? "none" : "block";
    menuIco.opened.style.display = !state.modalSmallMenuIsActive ? "none" : "block";
    //location
    modals.location.style.transform = state.modalSmallLocationIsActive ? "translateX(0px)" : "translateX(300px)";
    modals.location.style.opacity = state.modalSmallLocationIsActive ? "1" : "0.0";
    modals.location.style.pointerEvents = state.modalSmallLocationIsActive ? "all" : "none";
    buttons.location.style.backgroundColor = state.modalSmallLocationIsActive ? "#fff" : "#fff0";
} // setTimeout(() => render(), 1000);

//# sourceMappingURL=index.9692594d.js.map
